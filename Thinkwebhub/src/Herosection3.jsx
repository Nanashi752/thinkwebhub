...
import imglol from '../src/assets/herosection3.png'
import { FaArrowRightLong } from "react-icons/fa6";
const Herosection3 = () => {
  return (
    <div className='w-full z-[0] h-[35rem] relative flex items-center justify-center bg-black'>
      <div className='border-neutral-900 z-[2] text-white bg-neutral-950 w-2/3 h-[35rem] flex items-center justify-around absolute top-0 rounded-2xl'>
      <img src={imglol} className='w-[33rem] rounded-lg px-2'/>
