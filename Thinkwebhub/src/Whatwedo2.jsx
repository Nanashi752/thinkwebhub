...
const Whatwedo2 = () => {
  ...
  return (
    <div className='w-full h-[40rem] px-40 bg-black'>
        <div className='text-center text-5xl font-bold text-white selection:text-black selection:bg-orange-500 flex items-center justify-center'>What We <div className='text-[#F05742] px-3'>Do</div> </div>
